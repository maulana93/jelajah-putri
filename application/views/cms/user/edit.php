		...
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="content">
					<div class="row">
						<div class="col-lg-6">
							<h3 class="mb-0">User</h3><small>Edit Data</small>
						</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<?php echo form_open_multipart(base_url().'cms/user/edit'); ?> 
							...
							<?php } ?>
								<div class="form-group">
									...
									<input type="text" class="form-control" name="fullname" value="<?php echo isset($lists[0]['fullname'])?$lists[0]['fullname']:''; ?>" required>
								</div> 
								<div class="form-group">
									<label>Email</label>
									<input type="text" class="form-control" name="email" value="<?php echo isset($lists[0]['email'])?$lists[0]['email']:''; ?>" required>
								</div> 
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="form-check">
										...
										if(isset($lists[0]['role']) && $lists[0]['role']==1){
											echo 'checked';
										}
										?>>
									...
									<div class="form-check">
										...
										if(isset($lists[0]['role']) && $lists[0]['role']==2){
											echo 'checked';
										}
										?>>
								...
								<div class="form-group">
									...
									<div class="form-check">
										...
										if(isset($lists[0]['status']) && $lists[0]['status']==1){
											echo 'checked';
										}
										?>>
									...
									<div class="form-check">
										...
										if(isset($lists[0]['status']) && $lists[0]['status']==0){
											echo 'checked';
										}
										?>>
